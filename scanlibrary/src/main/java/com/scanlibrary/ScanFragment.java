...
//        int rotation = ImageUtils.getRotation(getUri().getPath());
//        original = ImageUtils.rotateImage(original, rotation);
        Bitmap scaledBitmap = scaledBitmap(original, sourceFrame.getWidth(), sourceFrame.getHeight());
        sourceImageView.setImageBitmap(scaledBitmap);
//        sourceImageView.setRotation(rotation);

        Bitmap tempBitmap = ((BitmapDrawable) sourceImageView.getDrawable()).getBitmap();
//        tempBitmap = ImageUtils.rotateImage(tempBitmap, rotation);
...
//            File file = Utils.getOutputMediaFile(Utils.MEDIA_TYPE_IMAGE_JPG);
//            Utils.writeToFile(bitmap, file);
//            bitmap.recycle();
            scanner.onScanFinish(bitmap);
        }
    }
